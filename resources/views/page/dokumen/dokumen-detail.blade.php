		...
		<div class="card-body row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body m-0 p-0">
						<img src="{{$dokumen->foto}}" alt="" class="img-modal">
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body m-0 p-0">
						<img src="{{$dokumen->passpor}}" alt="" class="img-modal">
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body m-0 p-0">
						<img src="{{$dokumen->kartu_keluarga}}" alt="" class="img-modal">
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body m-0 p-0">
						<img src="{{$dokumen->kartu_kuning}}" alt="" class="img-modal">
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body m-0 p-0">
						<img src="{{$dokumen->kartu_karyawan}}" alt="" class="img-modal">
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body m-0 p-0">
						<img src="{{$dokumen->ktp}}" alt="" class="img-modal">
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body m-0 p-0">
						<img src="{{$dokumen->buku_nikah}}" alt="" class="img-modal">
					</div>
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body m-0 p-0">
						<img src="{{$dokumen->akta}}" alt="" class="img-modal">
					</div>
