...
<div class="ml-2 mr-2">
	<div class="card">
		<div class="card-body">
			<div class="row">
				<div class="col-md-6">
					<h5>Data Kepulangan Peserta</h5>
				</div>
				<div class="col-md-3">
					<select id="inputState" class="form-control form-control-sm">
						<option selected>Pilih Field</option>
						<option value="0">Tanggal Kepulangan</option>
				...
				<div class="table-responsive" id="tablePrint">
					<table class="table" id="tableSearch">
						...
						<tbody>
							...
							<tr>
								<td>{{App\Helper\TimeFormat::timeId($item->tanggal_kepulangan)}}</td>
								<td>{{App\Http\Controllers\KeberangkatanPesertaController::produkPeserta($item->kode_produk)}} Orang</td>
								<td class="px-print">
									<a href="{{url('kepulangan-peserta').'/'.$item->kode_produk}}">Lihat</a>
								</td>
							</tr>
							@endforeach
						</tbody>
